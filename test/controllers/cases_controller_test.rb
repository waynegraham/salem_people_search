...
class CasesControllerTest < ActionController::TestCase
  ...
  test "should create case" do
    assert_difference('Case.count') do
      post :create, case: { case_id: @case.case_id, content: @case.content, doc_id: @case.doc_id, type: @case.type }
    end
  ...
  test "should update case" do
    patch :update, id: @case, case: { case_id: @case.case_id, content: @case.content, doc_id: @case.doc_id, type: @case.type }
    assert_redirected_to case_path(assigns(:case))
  end
